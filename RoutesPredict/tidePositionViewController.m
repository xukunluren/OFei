...
@interface tidePositionViewController ()<UITableViewDataSource,UITableViewDelegate,AGSWebMapDelegate,AGSMapViewLayerDelegate,AGSLayerDelegate,AGSMapViewTouchDelegate,CNPGridMenuDelegate,CPTPlotDataSource,CPTPlotSpaceDelegate,CPTAxisDelegate,CPTScatterPlotDataSource,FYChartViewDataSource>
{
...
-(void)setMapView:(NSString *)title
{
    ...
    AGSSimpleFillSymbol *myMarkerSymbol1 =
    [AGSSimpleFillSymbol simpleFillSymbol];
    myMarkerSymbol1.color = [UIColor whiteColor];
    myMarkerSymbol1.outline.width = 5;
    //    myMarkerSymbol2.
    myMarkerSymbol1.outline.color = [UIColor redColor];
    ...
    if ([title isEqualToString:@"霓屿山北堤航线"]) {
        ...
        [AGSGraphic graphicWithGeometry:poly
                             ...
                             attributes:nil];
        [_myGraphicsLayer addGraphic:myGraphic2];
        
        AGSGraphic* myGraphic3 =
        [AGSGraphic graphicWithGeometry:poly3
                                 symbol:myMarkerSymbol2
                             attributes:nil];
        [_myGraphicsLayer addGraphic:myGraphic3];
        ...
        [AGSGraphic graphicWithGeometry:poly4
                                 symbol:myMarkerSymbol2
                             attributes:nil];
        [_myGraphicsLayer addGraphic:myGraphic4];
