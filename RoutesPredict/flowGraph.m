...
{
    NSMutableArray *_flowTimeArr;
    NSMutableArray *_flowValueArr;
    NSMutableArray *_keduArray;
    NSMutableArray *_flowDir;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        _flowTimeArr = [[NSMutableArray alloc]init];
        _flowValueArr = [[NSMutableArray alloc]init];
...
//    _hostView.alpha = 0.6;
    ...
    plotSpace.yRange = [CPTPlotRange plotRangeWithLocationDecimal:CPTDecimalFromFloat(0.0) lengthDecimal:CPTDecimalFromFloat(2.0)];
...
-(NSURL *)judgeRoutes:(NSString *)title
{
    ...
    if ([title isEqualToString:@"霓屿山北堤航线"]) {
        url= [NSURL URLWithString:KRouteFlowP1];
    }
    if ([title isEqualToString:@"霓屿山东堤北段航线"]) {
        url= [NSURL URLWithString:KRouteFlowP2];
    }
    if ([title isEqualToString:@"凤凰山东堤南段航线"]) {
        url= [NSURL URLWithString:KRouteFlowP3];
    }
...
//    }
    ...
    lineStlye.lineColor  = [CPTColor blueColor];
                           ...
                           recordIndex:(NSUInteger)index
{
    ...
    if ([_flowDir[index] isEqualToString:@"E"]) {
    ...
    }else if ([_flowDir[index] isEqualToString:@"ENE"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"ESE"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"N"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"NE"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"NNE"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"NNW"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"NW"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"S"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"SE"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"SSE"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"SSW"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"SW"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"W"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"WNW"]) {
        ...
        plotSymbol.lineStyle = symbolLineStyle;
    }else if ([_flowDir[index] isEqualToString:@"WSW"]) {
...
-(void)scatterPlot:(CPTScatterPlot *)plot plotSymbolWasSelectedAtRecordIndex:(NSUInteger)idx withEvent:(UIEvent *)event
{
    ...
    NSNumber *x = [_flowValueArr objectAtIndex:idx];
    NSNumber *y = [_flowValueArr objectAtIndex:idx];
    NSString *date = [_flowTimeArr objectAtIndex:idx];
    NSString *dir = [_flowDir objectAtIndex:idx];
