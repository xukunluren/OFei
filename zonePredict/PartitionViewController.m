...
-(void)setNoFresh
{
    UILabel *unitName = [[UILabel alloc]initWithFrame:CGRectMake(KWight*0.15, 0.1*KHight, KWight*0.5, 0.2*KHight)];
    ...
    UIImageView *logo=[[UIImageView alloc]initWithFrame:CGRectMake(15,KHight*0.14 ,KWight*0.19 ,KWight*0.19)];
    ...
    //别写死
    _zoneA = [[UIImageView alloc]initWithFrame:CGRectMake(KWight*0.58, KHight*0.12, KWight*0.4, KWight*0.4)];
