...
- (void)drawRect:(CGRect)rect {
    ...
    //方向设置
    _windDirection = [[UILabel alloc]initWithFrame:CGRectMake(self.bounds.size.width*0.16, self.bounds.size.height*0.45, 100, 40)];
    ...
    _waveDirection  = [[UILabel alloc]initWithFrame:CGRectMake(self.bounds.size.width*0.65, self.bounds.size.height*0.45, 100, 40)];
    ...
    //方向设置
    _windDirection_48 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.16, kheight*0.67, 100, 40)];
//    _windDirection_48.backgroundColor = [UIColor blackColor];
    ...
    _waveDirection_48 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.65, kheight*0.67, 100, 40)];
    ...
    //方向设置
    _windDirection_72 = [[UILabel alloc]initWithFrame:CGRectMake(self.bounds.size.width*0.16, kheight*0.89, 100, 40)];
    ...
    _waveDirection_72 = [[UILabel alloc]initWithFrame:CGRectMake(kwidth*0.65, kheight*0.89, 100, 40)];
...
{
    NSURL *url_24 = [self judgeZone24:@"D区"];
    ...
    NSURL *url_48 = [self judgeZone48:@"D区"];
    ...
    NSURL *url_72 = [self judgeZone72:@"D区"];
