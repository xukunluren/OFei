...
@interface windViewController ()<UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate,AGSWebMapDelegate,AGSMapViewLayerDelegate,AGSLayerDelegate,AGSMapViewTouchDelegate,CNPGridMenuDelegate,CPTPlotSpaceDelegate,CPTScatterPlotDelegate>
...
//    AGSMapView *mapview = [[AGSMapView alloc] initWithFrame:CGRectMake(5,70, KWight*0.45, 0.35*KHight-44)];
...
//        }
       ...
       NSString *pubtime2=[pubtime  substringToIndex:16];
        ...
        cell.data4.text = windDirection[indexPath.row];
...
-(NSArray *)getDataFromNet:(NSString *)title
{
    ...
    _array = [NSJSONSerialization JSONObjectWithData:received options:NSJSONReadingMutableContainers error:nil];
