...
@interface flowViewController ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,AGSWebMapDelegate,AGSMapViewLayerDelegate,AGSLayerDelegate,AGSMapViewTouchDelegate,CPTPlotSpaceDelegate,CPTScatterPlotDelegate>
